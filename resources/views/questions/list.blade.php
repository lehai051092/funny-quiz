...
{{--                                <div>--}}
{{--                                    <a href="{{route('answers.delete',$answer->id)}}" class="btn btn-btn-danger"--}}
{{--                                       onclick="return confirm('Are you sure delete???')">Delete answer</a>--}}
...
{{--                    <a href="{{route('questions.delete',$question->id)}}" class="btn btn-danger"--}}
{{--                       onclick="return confirm('Are you sure delete???')">Delete question</a>--}}
