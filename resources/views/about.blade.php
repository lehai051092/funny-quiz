...
@section('content')
    ...
    <div class="breadcumb-area bg-img" style="background-image: url({{asset('storage/img/bg-img/breadcumb.jpg')}});">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="about-slides owl-carousel mt-100 wow fadeInUp" data-wow-delay="600ms">
                        <img src="{{asset('storage/img/bg-img/bg-3.jpg')}}" alt="">
                        <img src="{{asset('storage/img/bg-img/bg-2.jpg')}}" alt="">
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-teachers-area text-center mb-100 wow fadeInUp" data-wow-delay="400ms">
                        ...
                        <div class="teachers-thumbnail">
                            <img src="{{asset('storage/img/bg-img/tea1.jpg')}}" alt="">
                        </div>
                        <!-- Meta Info -->
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-teachers-area text-center mb-100 wow fadeInUp" data-wow-delay="500ms">
                        <!-- Thumbnail -->
                        <div class="teachers-thumbnail">
                            <img src="{{asset('storage/img/bg-img/tea2.jpg')}}" alt="">
                        </div>
                        <!-- Meta Info -->
                        <div class="teachers-info mt-30">
                            <h5>Simon Duval</h5>
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-teachers-area text-center mb-100 wow fadeInUp" data-wow-delay="600ms">
                        <!-- Thumbnail -->
                        <div class="teachers-thumbnail">
                            <img src="{{asset('storage/img/bg-img/tea3.jpg')}}" alt="">
                        </div>
                        <!-- Meta Info -->
                        <div class="teachers-info mt-30">
                            <h5>James Hogan</h5>
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-teachers-area text-center mb-100 wow fadeInUp" data-wow-delay="700ms">
                        <!-- Thumbnail -->
                        <div class="teachers-thumbnail">
                            <img src="{{asset('storage/img/bg-img/tea4.jpg')}}" alt="">
                        </div>
                        <!-- Meta Info -->
                        <div class="teachers-info mt-30">
