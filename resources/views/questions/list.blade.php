...
<div class=" p-5" style="background-image: url();width: 100%">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h3><span class="label label-warning" id="qid">{{++$key}}</span> {{$question->title}}
                                </h3>
                            </div>
                                        ...
                                        <div class="quiz" id="quiz" data-toggle="buttons">
                                            <label class="element-animation1 btn btn-lg btn-success btn-block"><span
                                                ...
                                                <input
                                                    ...
                                                    value="{{$answer->title}}">{{$answer->title}}</label><br>
                                        </div>
                                    @endif
